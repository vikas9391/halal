...
class Booking(models.Model):
    """A travel reservation and its payment selection."""
...
class Traveler(models.Model):
    """Traveler identity, passport status, accessibility response and documents."""
    ...
    MOBILITY_CHOICES = [
        ("yes", "Yes"),
        ("wheelchair_assistance", "Need help for pushing wheelchair"),
    ]
    ...
    passport_status = models.CharField(max_length=8, choices=PASSPORT_STATUS_CHOICES)
    mobility_assistance = models.CharField(max_length=24, choices=MOBILITY_CHOICES)
    passport_document = models.FileField(upload_to="private/passports/%Y/%m/", blank=False)
    passport_photo = models.ImageField(upload_to="private/passport-photos/%Y/%m/", blank=False)
