...
class Booking(models.Model):
    ...
    def __str__(self): return f"Booking #{self.id} — {self.tour.title}"
    @property
    def travelers_count(self): return self.travelers.count()
...
class Traveler(models.Model):
    ...
    passport_status = models.CharField(max_length=8, choices=PASSPORT_STATUS_CHOICES, default="valid")
    mobility_assistance = models.CharField(max_length=24, choices=MOBILITY_CHOICES, default="yes")
