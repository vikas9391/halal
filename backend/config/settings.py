...
# The frontend API contract uses the serializer field names (snake_case). Keep
# standard DRF JSON here rather than silently changing response keys to camelCase.
